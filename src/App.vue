    ...
    <nav class="sidebar">
      ...
      <div class="nav-items">
       ...
       <router-link to="/wordbank" class="nav-item" :class="{ active: $route.path === '/wordbank' }">
        ...
        <router-link to="/settings" class="nav-item" :class="{ active: $route.path === '/settings' }">
          ...
          <span>{{ t('nav.settings').value }}</span>
        </router-link>
      </div>
      <div class="nav-footer">
        ...
        <div class="streak-badge" v-if="progress.streakDays > 0">
          ...
          <span>{{ progress.streakDays }} {{ t('common.day').value }}</span>
        </div>
      </div>
    </nav>
...
.nav-footer { padding: 12px 16px; display: flex; flex-direction: column; gap: 10px; }
